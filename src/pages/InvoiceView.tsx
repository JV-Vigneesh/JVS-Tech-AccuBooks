      ...
      >
        ...
        <div className="border-2 border-black">
              ...
              <div className="w-64 p-4">
                <div className="text-center">
                  <div className="border-2 border-black px-4 py-2 mb-3 inline-block">
                    <h2 className="text-xl font-bold tracking-wide" style={{ color: '#000000' }}>TAX INVOICE</h2>
                  </div>
          ...
          <div className="flex border-b-2 border-black">
            ...
            <div className="flex-1 border-r-2 border-black">
              <div className="bg-gray-200 px-3 py-1.5 border-b border-black">
                <h3 className="font-bold text-sm" style={{ color: '#000000' }}>BILL TO</h3>
              </div>
              <div className="p-3 text-sm min-h-[120px]" style={{ color: '#000000' }}>
                <p className="font-bold text-base mb-1">{invoice.customerName}</p>
                <p className="whitespace-pre-line leading-tight">{invoice.customerAddress}</p>
            ...
            <div className="w-80">
              <div className="bg-gray-200 px-3 py-1.5 border-b border-black">
                <h3 className="font-bold text-sm" style={{ color: '#000000' }}>DISPATCH DETAILS</h3>
              </div>
          ...
          <table className="w-full border-collapse text-sm" style={{ color: '#000000' }}>
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border-b-2 border-r border-black p-2 text-left font-bold">Description of Goods</th>
                <th className="border-b-2 border-r border-black p-2 text-center w-16 font-bold">HSN</th>
                <th className="border-b-2 border-r border-black p-2 text-center w-14 font-bold">Cases</th>
          ...
          <div className="border-t-2 border-black">
            <div className="flex">
              ...
              <div className="flex-1 border-r-2 border-black p-3" style={{ color: '#000000' }}>
                ...
                <p className="text-sm font-bold mt-1">{numberToWords(invoice.total)}</p>
              </div>
              ...
              <div className="w-64 text-sm" style={{ color: '#000000' }}>
                <div className="flex justify-between px-3 py-1.5 border-b border-black">
                  ...
                  <span className="font-bold">{invoice.totalQty}</span>
                </div>
                <div className="flex justify-between px-3 py-1.5 border-b border-black">
          ...
          <div className="flex border-t-2 border-black">
            <div className="flex-1 border-r-2 border-black p-3" style={{ color: '#000000' }}>
              <h4 className="font-bold text-sm mb-2 border-b border-black pb-1">Bank Details</h4>
              <div className="text-sm space-y-0.5">
                {company?.bankName && <p><span className="font-semibold">Bank Name:</span> {company.bankName}</p>}
                {company?.bankAccount && <p><span className="font-semibold">A/c No.:</span> {company.bankAccount}</p>}
                {company?.bankIfsc && <p><span className="font-semibold">IFSC Code:</span> {company.bankIfsc}</p>}
              </div>
            </div>
            <div className="w-80 p-3" style={{ color: '#000000' }}>
              <h4 className="font-bold text-sm mb-2 border-b border-black pb-1">Declaration</h4>
              <p className="text-xs leading-tight">{invoice.declaration}</p>
            </div>
          </div>
          ...
          <div className="border-t-2 border-black p-4" style={{ color: '#000000' }}>
            <div className="flex justify-between items-end">
              <div className="text-center">
                <p className="text-xs mb-16">Receiver's Signature</p>
